...
export const AGENTS: AgentInfo[] = [
  ...
  { id: "impact_assessment", name: "Impact Assessment Agent", description: "EU EF 3.1 Life Cycle Impact Assessment — 16 impact categories, carbon footprint class, ISO 14040/14044, ISO 14067 PCF, PEF Method. Generates EPD-ready reports.", category: "compliance", phase: "all", compliance_refs: ["ESPR Art. 9", "Battery Reg Art. 7", "ISO 14040", "ISO 14044", "ISO 14067", "EF 3.1", "PEF 2021/2279"], skills: ["lcia_computation", "carbon_class_assignment", "ef31_16_categories", "epd_generation", "pef_normalization", "data_quality_assessment"], tools: ["ml_inference_service", "neo4j_knowledge_graph", "audit_logger"], llm_model: "Claude Sonnet 4", status: "active" },
