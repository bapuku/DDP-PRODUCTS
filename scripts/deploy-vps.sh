...
echo ""
echo "Services:"
echo "  Frontend:  http://$VPS_IP:3100"
echo "  API:       http://$VPS_IP:8100"
echo "  API Docs:  http://$VPS_IP:8100/docs"
echo "  Nginx:     http://$VPS_IP:8110"
echo "  Health:    http://$VPS_IP:8100/health"
echo ""
echo "Management:"
